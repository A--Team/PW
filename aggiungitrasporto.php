...
<html>
  ...
  <body onload="recupera_destinazioni()">
	...
	<div class="sottomenu_modifica">
	  ...
	  <button type="button" class="bottone_sottomenu" onclick="location.href='aggiungitrasporto.php'">Aggiungi trasporto</button>
	...
	<?php
	  ...
	  if($_SERVER["REQUEST_METHOD"]=="POST"){
	    if(isset($_POST["destinazione"]) && isset($_POST["tipologia"]) && isset($_POST["prezzo"]) && is_numeric($_POST["prezzo"])){
	      ...
	      $sql="INSERT INTO trasporto (prezzo,tipo,id_destinazione) VALUES('".$prezzo."','".$tipologia."','".$destinazione."')";
	      database::qInsertInto($conn,$sql);
	      echo "Trasporto ".$tipologia." inserito.";
	    }
	    else{
